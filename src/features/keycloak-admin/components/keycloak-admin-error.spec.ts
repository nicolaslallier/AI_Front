...
import KeycloakAdminError from './keycloak-admin-error.vue';
import { KeycloakAdminErrorType } from '../types/index';

import type { KeycloakAdminError as KeycloakAdminErrorType_Interface } from '../types/index';

describe('KeycloakAdminError', () => {
  const mockError: KeycloakAdminErrorType_Interface = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(KeycloakAdminError, {
  ...
  describe('error details', () => {
    it('should display error details when provided', () => {
      const errorWithDetails: KeycloakAdminErrorType_Interface = {
        ...mockError,
  ...
  describe('error type specific messages', () => {
    it('should handle NETWORK_ERROR type', () => {
      const networkError: KeycloakAdminErrorType_Interface = {
        type: KeycloakAdminErrorType.NETWORK_ERROR,
    ...
    it('should handle TIMEOUT_ERROR type', () => {
      const timeoutError: KeycloakAdminErrorType_Interface = {
    ...
    it('should handle IFRAME_ERROR type', () => {
      const iframeError: KeycloakAdminErrorType_Interface = {
    ...
    it('should handle UNKNOWN_ERROR type', () => {
      const unknownError: KeycloakAdminErrorType_Interface = {
  ...
  describe('props validation', () => {
    ...
    it('should update when error prop changes', async () => {
      ...
      const newError: KeycloakAdminErrorType_Interface = {
        type: KeycloakAdminErrorType.TIMEOUT_ERROR,
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on retry button', () => {
      ...
      const button = wrapper.find('button');
      expect(button.attributes('aria-label')).toBe('Retry loading Keycloak Admin');
    });
  });
