  ...
  <div class="relative w-full h-full min-h-screen">
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-4 text-gray-600 font-medium">Loading Keycloak Admin...</p>
      </div>
    </div>
...
/**
 * Keycloak Admin iframe component
 * Renders Keycloak Admin in an isolated iframe with loading state management
 *
...
export default defineComponent({
  name: 'KeycloakAdminIframe',

  props: {
    /**
     * URL of the Keycloak Admin instance to load
     */
    url: {
      type: String,
      required: true,
    ...
    /**
     * Whether Keycloak Admin is currently loading
     */
    isLoading: {
      type: Boolean,
      default: false,
