<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4" role="alert" aria-live="assertive">
    ...
    >
      ...
      <!-- Error Title -->
      <h2 class="text-xl font-bold text-gray-900 text-center mb-2">Keycloak Admin Unavailable</h2>
      ...
      <div class="flex justify-center">
        <button
          ...
          aria-label="Retry loading Keycloak Admin"
          @click="handleRetry"
        >
          <svg
...
import type { KeycloakAdminError } from '../types/index';

/**
 * Keycloak Admin error component
 * Displays user-friendly error messages when Keycloak Admin fails to load
 *
...
export default defineComponent({
  ...
  props: {
     ...
     */
    error: {
      type: Object as PropType<KeycloakAdminError>,
      required: true,
    },
  },
