...
import KeycloakAdminIframe from './keycloak-admin-iframe.vue';

describe('KeycloakAdminIframe', () => {
  const defaultProps = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(KeycloakAdminIframe, {
        props: defaultProps,
      });
  ...
  describe('loading state', () => {
    ...
    it('should display loading text when loading', () => {
      ...
      expect(wrapper.text()).toContain('Loading Keycloak Admin');
    });
  });
  ...
  describe('iframe attributes', () => {
    it('should have title attribute for accessibility', () => {
      ...
      const iframe = wrapper.find('iframe');
      expect(iframe.attributes('title')).toBe('Keycloak Admin Database Administration');
    });
