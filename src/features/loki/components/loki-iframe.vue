  ...
  <div class="relative w-full h-full min-h-full">
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-4 text-gray-600 font-medium">Loading Loki...</p>
      </div>
    </div>
...
/**
 * Loki iframe component
 * Renders Loki in an isolated iframe with loading state management
 *
...
export default defineComponent({
  ...
  props: {
    /**
     * URL of the Loki instance to load
     */
    url: {
      type: String,
      required: true,
    ...
    /**
     * Whether Loki is currently loading
     */
    isLoading: {
      type: Boolean,
      default: false,
