...
import LokiIframe from './loki-iframe.vue';
...
describe('LokiIframe', () => {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(LokiIframe, {
        props: defaultProps,
      });
  ...
  describe('loading state', () => {
    ...
    it('should display loading text when loading', () => {
      ...
      expect(wrapper.text()).toContain('Loading Loki');
    });
  });
  ...
  describe('iframe attributes', () => {
    it('should have title attribute for accessibility', () => {
      ...
      const iframe = wrapper.find('iframe');
      expect(iframe.attributes('title')).toBe('Loki Database Administration');
    });
