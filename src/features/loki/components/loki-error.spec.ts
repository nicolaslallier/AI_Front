...
import LokiError from './loki-error.vue';
import { LokiErrorType } from '../types/index';

import type { LokiError as LokiErrorType_Interface } from '../types/index';

describe('LokiError', () => {
  const mockError: LokiErrorType_Interface = {
  ...
  describe('error details', () => {
    it('should display error details when provided', () => {
      const errorWithDetails: LokiErrorType_Interface = {
        ...mockError,
  ...
  describe('error type specific messages', () => {
    it('should handle NETWORK_ERROR type', () => {
      const networkError: LokiErrorType_Interface = {
        type: LokiErrorType.NETWORK_ERROR,
    ...
    it('should handle TIMEOUT_ERROR type', () => {
      const timeoutError: LokiErrorType_Interface = {
    ...
    it('should handle IFRAME_ERROR type', () => {
      const iframeError: LokiErrorType_Interface = {
    ...
    it('should handle UNKNOWN_ERROR type', () => {
      const unknownError: LokiErrorType_Interface = {
  ...
  describe('props validation', () => {
    ...
    it('should update when error prop changes', async () => {
      ...
      const newError: LokiErrorType_Interface = {
        type: LokiErrorType.TIMEOUT_ERROR,
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on retry button', () => {
      ...
      const button = wrapper.find('button');
      expect(button.attributes('aria-label')).toBe('Retry loading Loki');
    });
  });
