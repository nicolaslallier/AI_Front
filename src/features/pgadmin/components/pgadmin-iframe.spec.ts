...
import PgAdminIframe from './pgadmin-iframe.vue';

describe('PgAdminIframe', () => {
  const defaultProps = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(PgAdminIframe, {
        props: defaultProps,
      });
  ...
  describe('loading state', () => {
    ...
    it('should display loading text when loading', () => {
      ...
      expect(wrapper.text()).toContain('Loading pgAdmin');
    });
  });
  ...
  describe('iframe attributes', () => {
    it('should have title attribute for accessibility', () => {
      ...
      const iframe = wrapper.find('iframe');
      expect(iframe.attributes('title')).toBe('pgAdmin Database Administration');
    });
