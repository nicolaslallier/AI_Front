...
import PgAdminError from './pgadmin-error.vue';
import { PgAdminErrorType } from '../types/index';

import type { PgAdminError as PgAdminErrorType_Interface } from '../types/index';

describe('PgAdminError', () => {
  const mockError: PgAdminErrorType_Interface = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(PgAdminError, {
  ...
  describe('error details', () => {
    it('should display error details when provided', () => {
      const errorWithDetails: PgAdminErrorType_Interface = {
        ...mockError,
  ...
  describe('error type specific messages', () => {
    it('should handle NETWORK_ERROR type', () => {
      const networkError: PgAdminErrorType_Interface = {
        type: PgAdminErrorType.NETWORK_ERROR,
    ...
    it('should handle TIMEOUT_ERROR type', () => {
      const timeoutError: PgAdminErrorType_Interface = {
    ...
    it('should handle IFRAME_ERROR type', () => {
      const iframeError: PgAdminErrorType_Interface = {
    ...
    it('should handle UNKNOWN_ERROR type', () => {
      const unknownError: PgAdminErrorType_Interface = {
  ...
  describe('props validation', () => {
    ...
    it('should update when error prop changes', async () => {
      ...
      const newError: PgAdminErrorType_Interface = {
        type: PgAdminErrorType.TIMEOUT_ERROR,
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on retry button', () => {
      ...
      const button = wrapper.find('button');
      expect(button.attributes('aria-label')).toBe('Retry loading pgAdmin');
    });
  });
