<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 px-4" role="alert" aria-live="assertive">
    ...
    >
      ...
      <!-- Error Title -->
      <h2 class="text-xl font-bold text-gray-900 text-center mb-2">pgAdmin Unavailable</h2>
      ...
      <div class="flex justify-center">
        <button
          ...
          aria-label="Retry loading pgAdmin"
          @click="handleRetry"
        >
          <svg
...
import type { PgAdminError } from '../types/index';

/**
 * pgAdmin error component
 * Displays user-friendly error messages when pgAdmin fails to load
 *
...
export default defineComponent({
  ...
  props: {
     ...
     */
    error: {
      type: Object as PropType<PgAdminError>,
      required: true,
    },
  },
