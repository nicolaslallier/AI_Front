...
import TempoError from './tempo-error.vue';
import { TempoErrorType } from '../types/index';

import type { TempoError as TempoErrorType_Interface } from '../types/index';

describe('TempoError', () => {
  const mockError: TempoErrorType_Interface = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(TempoError, {
  ...
  describe('error details', () => {
    it('should display error details when provided', () => {
      const errorWithDetails: TempoErrorType_Interface = {
        ...mockError,
  ...
  describe('error type specific messages', () => {
    it('should handle NETWORK_ERROR type', () => {
      const networkError: TempoErrorType_Interface = {
        type: TempoErrorType.NETWORK_ERROR,
    ...
    it('should handle TIMEOUT_ERROR type', () => {
      const timeoutError: TempoErrorType_Interface = {
    ...
    it('should handle IFRAME_ERROR type', () => {
      const iframeError: TempoErrorType_Interface = {
    ...
    it('should handle UNKNOWN_ERROR type', () => {
      const unknownError: TempoErrorType_Interface = {
  ...
  describe('props validation', () => {
    ...
    it('should update when error prop changes', async () => {
      ...
      const newError: TempoErrorType_Interface = {
        type: TempoErrorType.TIMEOUT_ERROR,
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on retry button', () => {
      ...
      const button = wrapper.find('button');
      expect(button.attributes('aria-label')).toBe('Retry loading Tempo');
    });
  });
