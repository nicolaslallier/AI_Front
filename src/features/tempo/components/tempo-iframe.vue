  ...
  <div class="relative w-full h-full min-h-screen">
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-4 text-gray-600 font-medium">Loading Tempo...</p>
      </div>
    </div>
    ...
    <iframe
      ...
      title="Tempo Database Administration"
      allowfullscreen
...
/**
 * Tempo iframe component
 * Renders Tempo in an isolated iframe with loading state management
 *
...
export default defineComponent({
  ...
  props: {
    /**
     * URL of the Tempo instance to load
     */
    url: {
      type: String,
      required: true,
    ...
    /**
     * Whether Tempo is currently loading
     */
    isLoading: {
      type: Boolean,
      default: false,
