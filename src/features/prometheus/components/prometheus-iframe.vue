  ...
  <div class="relative w-full h-full min-h-full">
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-4 text-gray-600 font-medium">Loading Prometheus...</p>
      </div>
    </div>
    ...
    <iframe
      ...
      title="Prometheus Database Administration"
      allowfullscreen
...
/**
 * Prometheus iframe component
 * Renders Prometheus in an isolated iframe with loading state management
 *
...
export default defineComponent({
  name: 'PrometheusIframe',

  props: {
    /**
     * URL of the Prometheus instance to load
     */
    url: {
      type: String,
      required: true,
    ...
    /**
     * Whether Prometheus is currently loading
     */
    isLoading: {
      type: Boolean,
      default: false,
