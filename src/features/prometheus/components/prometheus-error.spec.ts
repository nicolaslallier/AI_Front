...
import PrometheusError from './prometheus-error.vue';
import { PrometheusErrorType } from '../types/index';

import type { PrometheusError as PrometheusErrorType_Interface } from '../types/index';

describe('PrometheusError', () => {
  const mockError: PrometheusErrorType_Interface = {
  ...
  describe('component rendering', () => {
    it('should render the component', () => {
      const wrapper = mount(PrometheusError, {
  ...
  describe('error details', () => {
    it('should display error details when provided', () => {
      const errorWithDetails: PrometheusErrorType_Interface = {
        ...mockError,
  ...
  describe('error type specific messages', () => {
    it('should handle NETWORK_ERROR type', () => {
      const networkError: PrometheusErrorType_Interface = {
        type: PrometheusErrorType.NETWORK_ERROR,
    ...
    it('should handle TIMEOUT_ERROR type', () => {
      const timeoutError: PrometheusErrorType_Interface = {
    ...
    it('should handle IFRAME_ERROR type', () => {
      const iframeError: PrometheusErrorType_Interface = {
    ...
    it('should handle UNKNOWN_ERROR type', () => {
      const unknownError: PrometheusErrorType_Interface = {
  ...
  describe('props validation', () => {
    ...
    it('should update when error prop changes', async () => {
      ...
      const newError: PrometheusErrorType_Interface = {
        type: PrometheusErrorType.TIMEOUT_ERROR,
  ...
  describe('accessibility', () => {
    ...
    it('should have aria-label on retry button', () => {
      ...
      const button = wrapper.find('button');
      expect(button.attributes('aria-label')).toBe('Retry loading Prometheus');
    });
  });
